...
if (isset($_POST['save'])){
    ...
    $update_status = $con->updateStudents($first_name, $last_name,
     $email, $student_id);
     ...
     if ($update_status) {
        ...
        Swal.fire({
          ...
          text: 'You have successfully Edit the Student.',
  ...
  <div class="container py-5">
    ...
    <form method="POST" action="" class="bg-white p-4 rounded shadow-sm">
      <div class="mb-3">
        ...
        <input type="text" name="sid" value="<?php echo $student_data['student_id'] ?>"
